...
#리스트 슬라이싱 = 리스트로 나옴, 파이선은 띄어쓰기 잘해야함
su4=[10,10,100,1000,10000]
print(su4[2:3]) #[100]
print(su4[:3])  #[1,10,100]

su5=[10,10,100,["ab","cd","ef"],1000,10000]
...
k3[2:3] = []
print(k3)   #요소삭제 [100, '백', '만', '백만', '명량']

del k3[3]
print(k3)   #내장 함수를 이용한 요소삭제 [100, '백', '만', '명량']